...
Cases (2a) and (2b) do not have a standard specification for being input. Many fonts propose using `U+0640` [arabic tatweel]{.smallcaps} combined with `U+0670` [arabic superscript alef]{.smallcaps} for case (2a), and `U+00A0` [no-break space (nbsp)]{.smallcaps} or `U+202F` [narrow no-break space (nnbsp)]{.smallcaps} combined with `U+0670` [arabic superscript alef]{.smallcaps} for case (2b).
