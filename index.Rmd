...
Other fonts will automatically offset the Dagger Alef to the left if a [◌َ]{.ar} U+064E \textsc{arabic fatha} is encoded before it. Thus these fonts can display [هٰذا]{.ar} and [هَـٰذا]{.ar} but (problematically) not [هـٰذا]{.ar}.
